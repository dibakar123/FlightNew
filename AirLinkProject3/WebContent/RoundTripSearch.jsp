...
#flight-search {
	...
	<%
		...
		List<DFlight> dlist =null;
		//list = bdao.fsearch(source, destination, jdate);
		 if ( airline.equals("0") && class_type==null) {
			System.out.println("dfdsfdsf");
			//list = bdao.fsearch(source, destination, jdate);
		}
		else
			if (airline.equals("0") && class_type!=null) {
			System.out.println("dfdsfdsf1212");
		 dlist = bdao.fsearch(source, destination, jdate, class_type);
		}
			else
				if ((!(airline.equals("0")) && class_type!=null)) {
				
			 list = bdao.fsearch(source, destination, jdate, class_type,airline);
				}
	%>
<div class="container">
  <div class="row">
		...
		<div class="w-100 ml-0 pt-2">
			...
			<div class="row w-100 ml-0 py-2 text-center">
				...
				<div class="col-md-2">
					...
					<p>
					<form action="FlightBooks.jsp" id="flight-search">
